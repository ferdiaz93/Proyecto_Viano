...
const BODY_SERVICIO = document.getElementById("servicio");
const BODY_MARCADOS = document.getElementById("marcados");
const BODY_MARCADOSDOS = document.getElementById("marcadosdos");
...
function cambiarIdiomaBodyProductos(idioma) {
    switch (idioma) {
        case "eng":
            ...
            BODY_SERVICIO.innerText = "Service"
            BODY_MARCADOS.innerText = `Advice on ISO 9001 quality standards`
            BODY_MARCADOSDOS.innerText = "ISO 17025, ISO 14001 e IRAM.-NM 324"
        ...
        case "esp":
            ...
            BODY_SERVICIO.innerText = `Servicio`
            BODY_MARCADOS.innerText = `Asesoramiento de normas de calidad ISO 9001`
            BODY_MARCADOSDOS.innerText = "ISO 17025, ISO 14001 e IRAM.-NM 324"
    }
}
